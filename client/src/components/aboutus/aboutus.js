                    ...
                    <Row>
                        <Col className="m-0 p-0">
                            ...
                            <p className="AboutUsT mb-1 pb-1">
                                ...
                                <p className="m-1 p-0" style={{ fontFamily: 'Montserrat Regular', fontSize: '13px' }}><img className=" mr-2" src={process.env.PUBLIC_URL + "/images/Asset6.svg"} width={25} alt="" />Free Wifi</p>
                                <p className="m-1 p-0" style={{ fontFamily: 'Montserrat Regular', fontSize: '13px' }}><img className="air mr-2" src={process.env.PUBLIC_URL + "/images/Asset7.svg"} width={25} alt="" />Air-Conditioning</p>
                                <p className="m-1 p-0" style={{ fontFamily: 'Montserrat Regular', fontSize: '13px' }}><img className=" mr-2" src={process.env.PUBLIC_URL + "/images/Asset19new.svg"} width={23} alt="" />Option to Book Now and Pay later</p>
                                <p className="m-1 p-0" style={{ fontFamily: 'Montserrat Regular', fontSize: '13px' }}><img className="wash mr-2" src={process.env.PUBLIC_URL + "/images/Asset23.svg"} width={25} alt="" />Well-maintained washrooms</p>
                            </p>
                        </Col>
                    </Row>
                    <Row className="p-2">

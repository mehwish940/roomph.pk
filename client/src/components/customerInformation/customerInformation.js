  ...
  return (
    <div>
      {taxdetail.map((tax, index) => (
        <p key={index} className="RTX m-0 p-0" style={{ fontFamily: 'Gotham Rounded Light', whiteSpace: 'nowrap' }}>
          <span className="RTXR" style={{ fontFamily: 'Gotham Rounded Medium' }}>Tax ({tax.$.TaxPercent} {tax.$.TaxName}): </span><b> Rs. {tax.$.TaxPercent * rate / 100}</b>
        </p>
      )
      )}
    </div>
...
class CustomerInformation extends Component {
  ...
  handleButtonClicked() {
    ...
    History.push(`/thankyou/${this.props.match.params.city}/${this.props.match.params.checkin}/${this.props.match.params.checkout}/${this.props.match.params.adults}/${this.props.match.params.rooms}/${this.props.match.params.nights}/${idd}/${name}/${email}/${phoneNo}/${uCity}/${this.props.match.params.roomId}/${this.props.match.params.planId}/${this.props.match.params.roomq}/${this.props.match.params.rate}`)
      ...
      <div className="CustomerInformation">
        ...
        <section className="">
          ...
          <Container className="mb-3" fluid>
            <Row className="showingSignCont SignUpContCI">
              <Col>
            ...
            {this.state.loading ? <Container className="pl-1 CICont" style={{ backgroundColor: '#f6f6f6', borderRadius: '10px' }} fluid>
              <Row>
            ...
            <div className="regFormContainer" style={{ borderRadius: "15px 15px 30px 30px", border: "1px solid rgb(203, 203, 203)" }}>
              <Row className="mx-auto">
                <Col xs={12} className="regFrom">
                  <h6 className="mt-3 letUsknow" style={{ fontFamily: 'Gotham Rounded Bold' }}>Let us know who you are</h6>
                  <Form>
                    <Form.Group className="mt-3 mb-2" controlId="formBasicEmail">
                      <Form.Control value={this.state.name} onChange={this.handleNameChanged.bind(this)} className="mb-3 formPlace" type="text" placeholder="Full name *" style={{ height: "30px", borderRadius: "20px 20px 20px 20px", border: "1px solid rgb(203, 203, 203)", boxShadow: "1px 1px 1px 1px rgb(205, 206, 206)", fontFamily: "Montserrat Thin", color: 'black' }} />
                      <Form.Control value={this.state.email} onChange={this.handleEmailChanged.bind(this)} className="mb-3 formPlace" type="email" placeholder="Email *" style={{ height: "30px", borderRadius: "20px 20px 20px 20px", border: "1px solid rgb(203, 203, 203)", boxShadow: "1px 1px 1px 1px rgb(205, 206, 206)", fontFamily: "Montserrat Thin" }} />
                      <Form.Control value={this.state.reEmail} onChange={this.handleReEmailChanged.bind(this)} className="mb-3 formPlace" type="email" placeholder="Retype email *" style={{ height: "30px", borderRadius: "20px 20px 20px 20px", border: "1px solid rgb(203, 203, 203)", boxShadow: "1px 1px 1px 1px rgb(205, 206, 206)", fontFamily: "Montserrat Thin" }} />
                      <Form.Control value={this.state.phoneNo} onChange={this.handlePhoneNoChanged.bind(this)} className="float-right mb-3 formPlace" type="text" placeholder="City *" style={{ width: '50%', height: "30px", borderRadius: "20px 20px 20px 20px", border: "1px solid rgb(203, 203, 203)", boxShadow: "1px 1px 1px 1px rgb(205, 206, 206)", fontFamily: "Montserrat Thin" }} />
                      <Form.Control value={this.state.uCity} onChange={this.handleCityChanged.bind(this)} className="mb-3 formPlace" type="text" placeholder="Phone number *" style={{ width: '46%', height: "30px", borderRadius: "20px 20px 20px 20px", border: "1px solid rgb(203, 203, 203)", boxShadow: "1px 1px 1px 1px rgb(205, 206, 206)", fontFamily: "Montserrat Thin" }} />
                      <Form.Control value={this.state.promoCode} onChange={this.handlePromoCodeChanged.bind(this)} className="mb-3 formPlace" type="text" placeholder="Promo Code (Optional)" style={{ height: "30px", borderRadius: "20px 20px 20px 20px", border: "1px solid rgb(203, 203, 203)", boxShadow: "1px 1px 1px 1px rgb(205, 206, 206)", fontFamily: "Montserrat Thin" }} />
                    </Form.Group>
                  </Form>
                </Col>
              </Row>
              <Row className="mx-auto">
                <Col className="mt-1">
                  <p className="termCI" style={{ fontFamily: "Gotham Medium" }}>We’ll send your confirmation to this email address. <br />By processing with this booking, I am agreeing to Roomph’s <span ><a style={{ color: "#EF4E22" }} href="/terms">Terms & Conditions</a></span>
